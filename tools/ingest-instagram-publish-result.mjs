...
export function ingestPublishResult({ experiment, result, root = REPO }) {
...
async function main() {
  ...
  console.log(JSON.stringify(ingestPublishResult({ experiment, result }), null, 2));
}
