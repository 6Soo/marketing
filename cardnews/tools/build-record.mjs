// 기록용 HTML 빌더 — 기준본(그들이모르는일본-001-히다.html)과 같은 검토 페이지를 시리즈에서 생성.
...
const PAGE_CSS = `
  ...
  html, body { background: var(--bg); color: var(--fg); font-family: "Pretendard", "Apple SD Gothic Neo", -apple-system, "Malgun Gothic", sans-serif; -webkit-font-smoothing: antialiased; overflow-x: hidden; }
  ...
  .card-row { display: flex; gap: 18px; overflow-x: auto; padding: 30px 0 10px; scroll-snap-type: x proximity; }
